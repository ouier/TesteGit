object FrmAgendaDiaria: TFrmAgendaDiaria
  Left = 116
  Top = 162
  ...
  object StringGridPeriodo1Hora: TStringGrid
    Left = 11
    Top = 30
    Width = 578
    Height = 18
  ...
  object DBGridTabela: TDBGrid
    ...
    Height = 81
    Ctl3D = False
    DataSource = DataSourceDisponibilidade
    ParentCtl3D = False
    TabOrder = 3
    TitleFont.Charset = DEFAULT_CHARSET
    TitleFont.Color = clWindowText
  ...
  object DataSourceDisponibilidade: TDataSource
    AutoEdit = False
    DataSet = ZReadOnlyQueryDisponib
    Left = 507
    Top = 137
  end
  object ZReadOnlyQueryDisponib: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'Select * From reservas Where Id_Ambiente = :pIdAmbiente And Data' +
        ' = :pData Order By H_Inicio')
    ParamCheck = True
    Params = <
      item
        DataType = ftInteger
    ...
    object ZReadOnlyQueryDisponibID_RESERVA: TIntegerField
      FieldName = 'ID_RESERVA'
      Required = True
    end
    object ZReadOnlyQueryDisponibID_EVENTO: TIntegerField
      FieldName = 'ID_EVENTO'
      Required = True
    end
    object ZReadOnlyQueryDisponibID_AMBIENTE: TIntegerField
      FieldName = 'ID_AMBIENTE'
      Required = True
    end
    object ZReadOnlyQueryDisponibDATA: TDateTimeField
      FieldName = 'DATA'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object ZReadOnlyQueryDisponibSTATUS: TIntegerField
      FieldName = 'STATUS'
    end
    object ZReadOnlyQueryDisponibH_INICIO: TDateTimeField
      FieldName = 'H_INICIO'
      DisplayFormat = 'hh:nn:ss'
    end
    object ZReadOnlyQueryDisponibH_FIM: TDateTimeField
      DisplayWidth = 18
      FieldName = 'H_FIM'
      DisplayFormat = 'hh:nn:ss'
    end
