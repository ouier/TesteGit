...
type
  TFrmRecursoAlugado = class(TForm)
    ...
    ZQueryRecurso: TZQuery;
    DataSourceRecurso: TDataSource;
    ZQueryReserva: TZQuery;
    ZQueryRecursoID_RECURSO: TIntegerField;
    ZQueryRecursoNUMERO_PATRIMONIO: TIntegerField;
    ZQueryRecursoDESCRICAO: TStringField;
    ZQueryRecursoLOCALIZACAO: TStringField;
    ZQueryRecursoCUSTO: TFloatField;
    ZQueryReservaID_RESERVA_REC: TIntegerField;
    ZQueryReservaID_EVENTO_REC: TIntegerField;
    ZQueryReservaID_RECURSO: TIntegerField;
...
var
  FrmRecursoAlugado: TFrmRecursoAlugado;
...
procedure TFrmRecursoAlugado.ComboBoxAnoKeyPress(Sender: TObject; var Key: Char);
var
...
begin
    ...
    Begin
        ...
        ZQueryReserva.Close;
        ZQueryReserva.ParamByName('pIdRecurso').Value := ZQueryRecursoID_RECURSO.AsInteger;
...
procedure TFrmRecursoAlugado.FormCreate(Sender: TObject);
var
...
begin
    ...
    ZQueryRecurso.Close;
    ZQueryRecurso.ParamByName('pIdUnidade').Value := FrmDataModule.vCodUnidade;
    ZQueryRecurso.Open;

    ClientDataSetAgenda.Open;

    ComboBoxAno.ItemIndex := 0;
...
procedure TFrmRecursoAlugado.DBGridMinutosDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn;  State: TGridDrawState);
var
...
procedure TFrmRecursoAlugado.BitBtnFecharClick(Sender: TObject);
begin
    Close;
end;

procedure TFrmRecursoAlugado.FormClose(Sender: TObject;
...
procedure TFrmRecursoAlugado.FormKeyPress(Sender: TObject; var Key: Char);
begin
    If (Key = #13) And (Not ComboBoxAno.Focused) Then
        Keybd_Event(9, 0, 0, 0);
end;

procedure TFrmRecursoAlugado.ComboBoxMesesChange(Sender: TObject);
begin
    ClientDataSetAgenda.EmptyDataSet;
end;

procedure TFrmRecursoAlugado.ComboBoxAnoChange(Sender: TObject);
begin
    ClientDataSetAgenda.EmptyDataSet;
end;

procedure TFrmRecursoAlugado.DBLookupComboBox1Click(Sender: TObject);
begin
    ClientDataSetAgenda.EmptyDataSet;
end;
