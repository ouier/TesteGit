...
type
  TFrmAgendaDiariaRec = class(TForm)
...
var
  FrmAgendaDiariaRec: TFrmAgendaDiariaRec;
...
procedure TFrmAgendaDiariaRec.FormCreate(Sender: TObject);
var
...
procedure TFrmAgendaDiariaRec.PintaGrid(HoraInicial, HoraFinal: TDateTime);
var
...
procedure TFrmAgendaDiariaRec.BitBtnFecharClick(Sender: TObject);
begin
    Close;
end;
